...
<title>AU ONLINE EXAMINATIONS</title>
...
<div class="jumbotron text-center">
  <h1> AU Online Examination</h1> 
  <p>e-Examination portal</p> 
  <!--  form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:gold;font-family:stencil, sans-serif; font-size: 25px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:skyblue;font-family:Showcard Gothic, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -USER</b></span></h4>
      </div>
...
<div class="modal fade" id="myModal1">
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title title1"><span  style="color:maroon;font-family:Algerian, sans-serif; font-size: 25px !important;letter-spacing: 4px; "><b>SIGN UP</b></span></h4>
      </div>
      <div class="modal-body">
...
<div class="form-group">
  ...
  <div class="col-md-6"> 
    <input  type="submit"  style="background:lawngreen;" class="sub" value="sign up"  />
  </div>
</div>
</fieldset>
</form>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-4">
      ...
      <p>Students satisfaction is our satisfaction..</p>
    </div>
  </div>
  <br><br>
  <div class="row slideanim">
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
       <div class="col-sm-6">
      <div class="thumbnail">
        <img src="img/hem.jfif" alt="HEMANTH" width="400" height="300">
        <p><strong>HEMANTH SARAGADAM</strong></p>
        <p>AU 3RD YEAR CSSE</p>
      </div>
    </div>
    <div class="col-sm-6">
      <div class="thumbnail">
        <img src="img/1.JPG" alt="CHERAN" width="400" height="300">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>MACHA SHIV SAI RAM</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>SAI SURAJ KADIYALA</span></h4>
      </div>
      <div class="item">
        <h4>"ZING ZING AMAZING"<br><span>RAGHAVENDRA BEHARA</span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> ANDHRAPRADESH, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 8297413421 </p>
      <p><span class="glyphicon glyphicon-envelope"></span>hemusj31@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(17.7288, 83.3201);
